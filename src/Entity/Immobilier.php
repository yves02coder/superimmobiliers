 ...
 * @ORM\Table(name="immobilier",indexes={@ORM\Index(columns={ "title","description"},flags={"fulltext"})})
 */
class Immobilier
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Image::class, mappedBy="immobilier",
    ...
    public function setFloor(bool $floor): self
    {
        $this->floor = $floor;
